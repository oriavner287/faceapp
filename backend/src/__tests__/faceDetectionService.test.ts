...
describe("FaceDetectionService", () => {
  ...
  describe("Face Detection", () => {
    ...
    it("should handle multiple face detection and select largest", async () => {
      ...
      const largestFace = (service as any).selectLargestFace(result.faces)
  ...
  describe("Image Preprocessing", () => {
    it("should handle large images by resizing", async () => {
      ...
      const preprocessed = await (service as any).preprocessImage(largeImage)
    ...
    it("should handle small images without resizing", async () => {
      ...
      const preprocessed = await (service as any).preprocessImage(smallImage)
      expect(Buffer.isBuffer(preprocessed)).toBe(true)
      expect(preprocessed.length).toBeGreaterThan(0)
    })
    ...
    it("should handle preprocessing errors gracefully", async () => {
      ...
      const preprocessed = await (service as any).preprocessImage(invalidImage)
  ...
  describe("Largest Face Selection", () => {
    it("should select single face when only one exists", () => {
      ...
      const largest = (service as any).selectLargestFace([face])
    ...
    it("should select largest face from multiple faces", () => {
      ...
      const largest = (service as any).selectLargestFace([
        smallFace,
        largeFace,
        mediumFace,
      ])
  ...
  describe("Error Handling", () => {
    it("should handle initialization errors", async () => {
      ...
      const newService = new (FaceDetectionService as any)()
      ...
      const result = await newService.detectFaces(
        await TestImageGenerator.createTestImage()
      )
