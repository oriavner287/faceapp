...
export class RequestValidator {
   ...
   */
  static validateProcessImageRequest(request: any): ValidationResult {
   ...
   */
  static validateGetResultsRequest(request: any): ValidationResult {
    const errors: ValidationError[] = []
   ...
   */
  static validateConfigureSearchRequest(request: any): ValidationResult {
    const errors: ValidationError[] = []
   ...
   */
  static validateFetchVideosRequest(request: any): ValidationResult {
    const errors: ValidationError[] = []
   ...
   */
  private static validateThreshold(threshold: any): ValidationResult {
    const errors: ValidationError[] = []
   ...
   */
  private static validateEmbedding(embedding: any): ValidationResult {
    const errors: ValidationError[] = []
...
export class ErrorResponseBuilder {
  static createValidationError(errors: ValidationError[]): {
    success: false
    error: {
      code: ErrorCode
      message: string
...
export class SimilarityUtils {
   ...
   */
  static meetsThreshold(similarity: number, threshold: number): boolean {
   ...
   */
  static normalizeSimilarity(similarity: number): number {
