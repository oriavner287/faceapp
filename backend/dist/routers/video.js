...
export const videoRouter = os.router({
    fetchFromSites: os
        ...
        try {
            ...
            const processingResult = await thumbnailProcessingService.processThumbnailsForFaceDetection(downloadResult.processedVideos, input.embedding, input.threshold || 0.7, {
                batchSize: 5,
                maxConcurrency: 3,
                skipOnError: true,
                logProgress: true,
